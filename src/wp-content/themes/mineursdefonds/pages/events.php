...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_bloginfo( 'template_url' ) ?>/sass/mineursdefonds/eventsPage.css">
	<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>

	<div class="eventsPage" style="background-image: url('<?php echo get_bloginfo( 'template_url' ) ?>/images/wall.jpg')">
        <header>
			...
			while ( have_posts() ) {
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <div class="entry-content">
						<?php the_title( '<h1 class="eventsPage-title">', '</h1>' ); ?>
